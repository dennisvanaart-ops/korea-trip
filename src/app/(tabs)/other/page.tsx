        ...
        <Card>
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="text-xs text-gray-400 mt-0.5">Aankomst Seoul · 29 april 2026</p>
            </div>
            <NavTrigger
              name="Incheon Airport Terminal 1 aankomsthal"
              query="Incheon International Airport Terminal 1"
        ...
        <Card>
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <p className="text-xs text-gray-400 mt-0.5">Busan · 7 mei 2026</p>
            </div>
            <NavTrigger
              name="Mipo Station (Sky Capsule vertrek)"
              query="Haeundae Mipo Station Busan"
              className="flex-shrink-0 mt-0.5"
            />
          </div>
          <Hr />
